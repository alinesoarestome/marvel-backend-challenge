...
public class CharacterServiceTests {
	...
	characters.add(new Character(1, "Hulk", "a green-skinned hero", new Date(), null));
	characters.add(new Character(2, "Deadpool", "a highly trained assassin and mercenary", new Date(), null));
	...
	Optional<Character> character = Optional
		.ofNullable(new Character(1, "Hulk", "a green-skinned hero", new Date(), null));
